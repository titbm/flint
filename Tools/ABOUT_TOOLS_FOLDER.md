...
| Файл | Назначение |
|------|------------|
| `annotate_v2.py` | Генерация аннотированных скриншотов с подписями элементов интерфейса |
| `generate_screenshots.py` | Автоматический захват скриншотов программы в DOSBox-X |
| `replace_screenshots.py` | Замена скриншотов в Help/screenshots/ новыми версиями |
