...
**32-битная версия** (папка `Flint 2.77 (WTCM32) src/`) — порт программы на компилятор Open Watcom C++ с DOS-экстендером DOS/4GW. Снимает ограничение 16-bit версии на ~80 000 точек и позволяет работать с моделями до 8 000 000 точек.
...
│   ├── 16BCC_FLINT_250326_053135/   — архив сборки с конфигами и примерами
